...
- Reference the commands in `.github/copilot/commands/` for structured workflows
...
## Available Commands
This project includes custom commands in `.github/copilot/commands/` to assist with:
